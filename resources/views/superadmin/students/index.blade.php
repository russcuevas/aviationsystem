                        ...
                        <tr>
                            <td>
                                <div class="school-code-wrap">
                                    <span class="school-code">STU-2024-021</span>
                                </div>
                            </td>
                            <td>Carlos Santos</td>
                ...
                <form id="addStudentForm" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="flyingSchool" class="form-label">Flying School</label>
                                <input type="text" class="form-control" id="flyingSchool" name="flyingSchool"
                                    required>
                            </div>
                            <div class="col-md-6">
