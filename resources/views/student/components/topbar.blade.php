        ...
        <div class="user-menu" id="userMenu">
            <button class="user-menu-trigger" id="userMenuToggle" type="button" aria-haspopup="true"
                ...
                <div class="user-avatar"
                    ...
                    {{ strtoupper(substr(session('student_name', 'ST'), 0, 2)) }}
                </div>
                <div class="user-menu-trigger-text">
                    <div class="user-menu-trigger-name">{{ session('student_name', 'Student Pilot') }}</div>
                    <div class="user-menu-trigger-role">Student Pilot</div>
                </div>
                <i class="bi bi-chevron-down user-menu-trigger-chevron"></i>
            </button>
            <div class="user-menu-dropdown" id="userMenuDropdown">
                <button class="user-menu-item" type="button"><i class="bi bi-person"></i>Profile</button>
                <button class="user-menu-item logout" type="button" onclick="window.location.href='{{ route('logout') }}'"><i
