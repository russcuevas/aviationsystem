<aside class="sidebar" id="sidebar">
    ...
    <div style="overflow-y:auto; flex:1; padding-bottom:10px;">
        ...
        <nav class="nav flex-column px-0" style="gap:2px;">
            ...
            <a class="nav-link" href="grade_sheets.html"><i class="bi bi-journal-check nav-icon"></i><span>Grade
                    Viewing</span></a>
            <a class="nav-link" href="logbooks.html"><i class="bi bi-journal-text nav-icon"></i><span>Aircraft
                    Logbook</span></a>
        </nav>
    </div>
</aside>
