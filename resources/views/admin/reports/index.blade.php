        ...
        <div class="panel">
            <div class="panel-header">
                ...
                <div style="display:flex;gap:8px;flex-wrap:wrap;">
                    <a href="{{ route('admin.reports.export.pdf') }}" class="btn-add-form" style="text-decoration:none;"><i class="bi bi-filetype-pdf"></i> Export PDF</a>
                    <a href="{{ route('admin.reports.export.excel') }}" class="btn-add-form" style="text-decoration:none;"><i class="bi bi-file-earmark-excel"></i> Export Excel</a>
                </div>
            </div>
